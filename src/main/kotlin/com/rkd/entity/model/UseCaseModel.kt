...
import com.rkd.entity.definition.MessageDefinition.UseCase
...
class UseCaseModel : AuditModel() {
    @field:NotBlank(message = UseCase.DESCRIPTION_CANNOT_BLANK)
    @JsonView(Public::class)
    @Column(nullable = false)
    var description: String? = null

    @field:NotNull(message = UseCase.STRUCTURE_CANNOT_BLANK)
    @JsonView(Public::class)
    ...
    @field:NotBlank(message = UseCase.PROJECT_ID_CANNOT_BLANK)
    @JsonView(Public::class)
    @ManyToOne
